/*
  ...
  # Problem
    ...
    Def. Cactus
      無向グラフ G が Cactus であるとは，G のすべての辺が高々1つの単純閉路にしか含まれない連結グラフ．
  ...
  　ここで，T の各辺は高々1度しか塗られなく，|E| <= 2 * |V| - 3 と仮定しているので，
  　O(n) 時間で判定可能である．

  　その他にも，G を2点連結成分分解して，各2点連結成分が単純閉路か道となっているならば，
  　G が Cactus であるという判定方法もある．上で説明したアルゴリズムは本質的には2点連結成分分解
  　と同じことをしている．
